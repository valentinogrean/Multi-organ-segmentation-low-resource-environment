...
data_path = "/home/vali/src/datasets/multi-organ-segthor-esophagus"
...
cb_model_val_loss = ModelCheckpoint("/home/vali/src/NeuralNetworks/segthor-esophagus-val-loss.hdf5",
                                   monitor="val_loss", verbose=1,
                                   save_best_only=True, mode="min")
cb_model_loss = ModelCheckpoint("/home/vali/src/NeuralNetworks/segthor-esophagus-loss.hdf5",
                                   monitor="loss", verbose=1,
                                   save_best_only=True, mode="min")

# normal learning
#model.reset_weights()
model.load("/home/vali/src/NeuralNetworks/segthor-esophagus-loss.hdf5")
